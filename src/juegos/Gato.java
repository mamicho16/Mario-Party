...
public class Gato extends javax.swing.JFrame {
     ...
     */
    public Gato(int j1, int j2, SistemaDeJuego sistema) {
        this.j1 = j1;
        this.j2 = j2;
    ...
    public boolean ganarFila(int jugador){
        for (int i = 0; i < 3; i++) {
            int cont=0;
            for (int j = 0; j < 3; j++) {
            ...
            if (cont==3){
                if(jugador == 1){
                    sistema.getJugadores().get(j1-1).ganoJuego = true;
                }
                return true;
    ...
    public boolean ganarColumna(int jugador){
        for (int i = 0; i < 3; i++) {
            int cont=0;
            for (int j = 0; j < 3; j++) {
    ...
    public boolean ganarDiagonal(int jugador){
    ...
    public boolean ganar(int jugador){
        return (ganarFila(jugador)||ganarColumna(jugador)||ganarDiagonal(jugador));
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (primero){
            ...
            primero=!primero;
            if (ganar(1)){
                JOptionPane.showMessageDialog(null, "El jugador " + j1 + " ha ganado");
                jButton1.setEnabled(false);
            ...
            primero=!primero;
            if (ganar(2)){
                JOptionPane.showMessageDialog(null, "El jugador " + j2 + " ha ganado");
                jButton1.setEnabled(false);
                jButton2.setEnabled(false);
                jButton3.setEnabled(false);
                jButton4.setEnabled(false);
